...
const main = async () => {
    ...
    const config = {
        ...
        hidden_layers: [2,4], //Value represents number of neurons in each hidden layer
        data: data.getData(), //Load json dataset 
        activation_method: 'sigmoid', //Function of activation name
        tournament_size: 6, //Number of individuals participate in each tournament 
        ...
        error_tolerance: 0.1, //Score stop criterium
